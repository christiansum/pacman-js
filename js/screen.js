...
let drawScreen = () => {
	...
	context.fillText("Score: ", sObj.startOnX, sObj.startOnY - 10);
};
...
let drawPoints = (points) => {
	context.fillStyle = sObj.backgroundColor;
	context.fillRect(sObj.startOnX + 65, sObj.startOnY - 30, 65, 25);
	context.fillStyle = "yellow";
	context.font = "20px Arial";
